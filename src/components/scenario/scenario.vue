<template>
	<md-card>
		...
		<md-card-content>
			...
			<md-input-container>
				<label>Weapon</label>
				<md-input placeholder="Caliber (mm)" type="number" min="0" v-model.number="scenario.weapon.caliber"></md-input>
			...
			<md-input-container>
				...
				<md-input placeholder="Weight (g)" type="number" min="0" v-model.number="scenario.ammunition.weight"></md-input>
			...
			<md-input-container>
				<label>Target</label>
				<md-input placeholder="Size (cm)" type="number" min="0" v-model.number="scenario.target.size"></md-input>
		...
		<md-card-actions>
			<md-button v-on:click="clear">Clear</md-button>
